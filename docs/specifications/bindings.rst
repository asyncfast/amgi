...
-  ``message["bindings"]["kafka"]["key"]`` (:py:obj:`~typing.NotRequired` [ :py:obj:`~typing.Optional` [:py:obj:`bytes` ]]) -
...
The Pulsar binding object has the following key:

-  ``message["bindings"]["pulsar"]["key"]`` (:py:obj:`~typing.NotRequired` [ :py:obj:`~typing.Optional` [:py:obj:`str` ]]) -
   The :py:obj:`str` of the Pulsar partition key, this can be also be :py:obj:`None`. If missing, it defaults to
   :py:obj:`None`.
